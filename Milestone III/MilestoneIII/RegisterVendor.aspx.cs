...
namespace MilestoneIII
{
    public partial class RegisterVendor : System.Web.UI.Page
    {
        ...
        protected void register(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd2 = new SqlCommand("vendorRegister", conn);
            ...
            string bankAccNum = txt_bankAccNum.Text;
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        cmd2.Parameters.Add(new SqlParameter("@company_name", companyName));
                        cmd2.Parameters.Add(new SqlParameter("@bank_acc_no", bankAccNum));
