<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterVendor.aspx.cs" Inherits="MilestoneIII.RegisterVendor" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <h1 style="color:cadetblue"> Vendor registration </h1>
            ...
            <asp:Label ID="lbl_companyName" runat="server" Text="Company name: " ForeColor="DarkSlateGray"></asp:Label>
            <asp:TextBox ID="txt_companyName" runat="server" BackColor="DarkSlateGray" BorderColor="DarkSlateGray" style="color:aliceblue"></asp:TextBox>

            <br/>
            <br/>

            <asp:Label ID="lbl_bankAccNum" runat="server" Text="Bank account number: " ForeColor="DarkSlateGray"></asp:Label>
            <asp:TextBox ID="txt_bankAccNum" runat="server" BackColor="DarkSlateGray" BorderColor="DarkSlateGray" style="color:aliceblue"></asp:TextBox>
